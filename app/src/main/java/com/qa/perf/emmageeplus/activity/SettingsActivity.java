...
public class SettingsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout mailSettings = (LinearLayout) findViewById(R.id.mail_settings);
        ...
        timeBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar arg0) {
                ...
                preferences.edit().putInt(Settings.KEY_INTERVAL, interval).apply();
            }
        });
        ...
        floatingItem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                preferences.edit().putBoolean(Settings.KEY_ISFLOAT, !isChecked).apply();
            }
        });
        ...
        autoStopItem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                preferences.edit().putBoolean(Settings.KEY_AUTO_STOP, !isChecked).apply();
            }
        });
        ...
        layHeapItem.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (isChecked) {
                    ...
                    preferences.edit().putBoolean(Settings.KEY_ROOT, false).apply();
                } else {
                    boolean root = upgradeRootPermission(getPackageCodePath());
                    if (root) {
                        Log.d(LOG_TAG, "root succeed");
                        chkRoot.setChecked(true);
                        preferences.edit().putBoolean(Settings.KEY_ROOT, true).apply();
                    } else {
        ...
        chkRoot.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View arg0) {
                // if root checkbox is checked, change status to
                // opposite;otherwise, try to upgrade app to root
